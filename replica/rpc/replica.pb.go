...
It has these top-level messages:
	...
	DiskPrepareRemoveReply
	DiskMarkAsRemovedRequest
...
func (*ReplicaCreateRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ReplicaRevertRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type ReplicaSnapshotRequest struct {
	Name        string            `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	UserCreated bool              `protobuf:"varint,2,opt,name=userCreated" json:"userCreated,omitempty"`
...
func (*ReplicaSnapshotRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*DiskRemoveRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*DiskReplaceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*DiskPrepareRemoveRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
type DiskPrepareRemoveReply struct {
	Operations []*PrepareRemoveAction `protobuf:"bytes,1,rep,name=operations" json:"operations,omitempty"`
}
...
func (*DiskPrepareRemoveReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*DiskMarkAsRemovedRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
type RebuildingSetRequest struct {
	Rebuilding bool `protobuf:"varint,1,opt,name=rebuilding" json:"rebuilding,omitempty"`
}
...
func (*RebuildingSetRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*RevisionCounterSetRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
type DiskInfo struct {
	...
	Children    map[string]bool   `protobuf:"bytes,3,rep,name=children" json:"children,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	Removed     bool              `protobuf:"varint,4,opt,name=removed" json:"removed,omitempty"`
	UserCreated bool              `protobuf:"varint,5,opt,name=userCreated" json:"userCreated,omitempty"`
...
func (*DiskInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
type Replica struct {
	...
	Rebuilding      bool                 `protobuf:"varint,2,opt,name=rebuilding" json:"rebuilding,omitempty"`
	...
	SectorSize      int64                `protobuf:"varint,6,opt,name=sectorSize" json:"sectorSize,omitempty"`
	BackingFile     string               `protobuf:"bytes,7,opt,name=backingFile" json:"backingFile,omitempty"`
	State           string               `protobuf:"bytes,8,opt,name=state" json:"state,omitempty"`
	Chain           []string             `protobuf:"bytes,9,rep,name=chain" json:"chain,omitempty"`
	Disks           map[string]*DiskInfo `protobuf:"bytes,10,rep,name=disks" json:"disks,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	RemainSnapshots int32                `protobuf:"varint,11,opt,name=remainSnapshots" json:"remainSnapshots,omitempty"`
	RevisionCounter int64                `protobuf:"varint,12,opt,name=revisionCounter" json:"revisionCounter,omitempty"`
}

func (m *Replica) Reset()                    { *m = Replica{} }
func (m *Replica) String() string            { return proto.CompactTextString(m) }
func (*Replica) ProtoMessage()               {}
func (*Replica) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*PrepareRemoveAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
// Client API for ReplicaService service
...
type ReplicaServiceClient interface {
	...
	ReplicaDelete(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
	ReplicaGet(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error)
	ReplicaOpen(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error)
	ReplicaClose(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error)
	ReplicaReload(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error)
...
func (c *replicaServiceClient) ReplicaCreate(ctx context.Context, in *ReplicaCreateRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaCreate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) ReplicaDelete(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaDelete", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) ReplicaGet(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaGet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) ReplicaOpen(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaOpen", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) ReplicaClose(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaClose", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) ReplicaReload(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaReload", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) ReplicaRevert(ctx context.Context, in *ReplicaRevertRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaRevert", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) ReplicaSnapshot(ctx context.Context, in *ReplicaSnapshotRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/ReplicaSnapshot", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) DiskRemove(ctx context.Context, in *DiskRemoveRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/DiskRemove", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) DiskReplace(ctx context.Context, in *DiskReplaceRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/DiskReplace", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) DiskPrepareRemove(ctx context.Context, in *DiskPrepareRemoveRequest, opts ...grpc.CallOption) (*DiskPrepareRemoveReply, error) {
	...
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/DiskPrepareRemove", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) DiskMarkAsRemoved(ctx context.Context, in *DiskMarkAsRemovedRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/DiskMarkAsRemoved", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) RebuildingSet(ctx context.Context, in *RebuildingSetRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/RebuildingSet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaServiceClient) RevisionCounterSet(ctx context.Context, in *RevisionCounterSetRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := grpc.Invoke(ctx, "/rpc.ReplicaService/RevisionCounterSet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for ReplicaService service

type ReplicaServiceServer interface {
	ReplicaCreate(context.Context, *ReplicaCreateRequest) (*Replica, error)
	ReplicaDelete(context.Context, *google_protobuf.Empty) (*google_protobuf.Empty, error)
	ReplicaGet(context.Context, *google_protobuf.Empty) (*Replica, error)
	ReplicaOpen(context.Context, *google_protobuf.Empty) (*Replica, error)
	ReplicaClose(context.Context, *google_protobuf.Empty) (*Replica, error)
	ReplicaReload(context.Context, *google_protobuf.Empty) (*Replica, error)
...
func _ReplicaService_ReplicaDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicaServiceServer).ReplicaDelete(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ReplicaService_ReplicaGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicaServiceServer).ReplicaGet(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ReplicaService_ReplicaOpen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicaServiceServer).ReplicaOpen(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ReplicaService_ReplicaClose_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicaServiceServer).ReplicaClose(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ReplicaService_ReplicaReload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicaServiceServer).ReplicaReload(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
