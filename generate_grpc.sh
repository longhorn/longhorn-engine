...
python -m grpc_tools.protoc -I pkg/engine/controller/rpc/pb -I vendor_proto/protobuf/src/ --python_out=integration/rpc/controller --grpc_python_out=integration/rpc/controller pkg/engine/controller/rpc/pb/controller.proto
...
python -m grpc_tools.protoc -I pkg/engine/replica/rpc -I vendor_proto/protobuf/src/ --python_out=integration/rpc/replica --grpc_python_out=integration/rpc/replica pkg/engine/replica/rpc/replica.proto
