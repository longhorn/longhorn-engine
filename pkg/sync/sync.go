...
func (t *Task) AddReplica(volumeSize, volumeCurrentSize int64, address, instanceName string, fileSyncHTTPClientTimeout int, fastSync bool, localSync *types.FileLocalSync) error {
	volume, err := t.client.VolumeGet()
	if err != nil {
		return err
	}
	...
	if err = toClient.SyncFiles(fromAddress, resp, fileSyncHTTPClientTimeout, fastSync, localSync); err != nil {
		return err
	}
