...
// https://github.com/aws/aws-sdk-go-v2/issues/1816#issuecomment-1927281540 @ganigeorgiev
//
// ignoreSigningHeaders excludes the listed headers from the request signature because some providers may alter them.
