...
_SNAPSHOTCLONEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='from_volume_name', full_name='ptypes.SnapshotCloneRequest.from_volume_name', index=5,
...
_BACKUPCREATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object_store_backup', full_name='ptypes.BackupCreateRequest.object_store_backup', index=11,
