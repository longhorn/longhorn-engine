...
class ControllerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.VolumeBench = channel.unary_unary(
                ...
                request_serializer=controller__pb2.VolumeBenchRequest.SerializeToString,
                response_deserializer=controller__pb2.VolumeBenchResponse.FromString,
                )
...
def add_ControllerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'VolumeBench': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=controller__pb2.VolumeBenchRequest.FromString,
                    response_serializer=controller__pb2.VolumeBenchResponse.SerializeToString,
            ),
...
class ControllerService(object):
    ...
    def VolumeBench(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ptypes.ControllerService/VolumeBench',
            controller__pb2.VolumeBenchRequest.SerializeToString,
            controller__pb2.VolumeBenchResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
