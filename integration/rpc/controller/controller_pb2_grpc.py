...
class ControllerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.VolumeSnapshotMaxCountSet = channel.unary_unary(
        ...
        request_serializer=controller__pb2.VolumeSnapshotMaxCountSetRequest.SerializeToString,
        response_deserializer=controller__pb2.Volume.FromString,
        )
    self.VolumeSnapshotMaxSizeSet = channel.unary_unary(
        '/ptypes.ControllerService/VolumeSnapshotMaxSizeSet',
        request_serializer=controller__pb2.VolumeSnapshotMaxSizeSetRequest.SerializeToString,
        response_deserializer=controller__pb2.Volume.FromString,
        )
...
def add_ControllerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'VolumeSnapshotMaxCountSet': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=controller__pb2.VolumeSnapshotMaxCountSetRequest.FromString,
          response_serializer=controller__pb2.Volume.SerializeToString,
      ),
      'VolumeSnapshotMaxSizeSet': grpc.unary_unary_rpc_method_handler(
          servicer.VolumeSnapshotMaxSizeSet,
          request_deserializer=controller__pb2.VolumeSnapshotMaxSizeSetRequest.FromString,
          response_serializer=controller__pb2.Volume.SerializeToString,
      ),
