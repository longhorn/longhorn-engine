...
class ControllerService(object):
    ...
    @staticmethod
    def BackupReplicaMappingCreate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ptypes.ControllerService/BackupReplicaMappingCreate',
            controller__pb2.BackupReplicaMapping.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def BackupReplicaMappingGet(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ptypes.ControllerService/BackupReplicaMappingGet',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            controller__pb2.BackupReplicaMap.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def BackupReplicaMappingDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ptypes.ControllerService/BackupReplicaMappingDelete',
            controller__pb2.BackupReplicaMappingDeleteRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def MetricGet(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/ptypes.ControllerService/MetricGet',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            controller__pb2.MetricGetReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
