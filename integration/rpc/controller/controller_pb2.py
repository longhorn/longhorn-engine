...
_VOLUME = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maximum_snapshot_count', full_name='ptypes.Volume.maximum_snapshot_count', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maximum_total_snapshot_size', full_name='ptypes.Volume.maximum_total_snapshot_size', index=11,
...
_VOLUMEMAXIMUMSNAPSHOTCOUNTSETREQUEST = _descriptor.Descriptor(
  name='VolumeSnapshotMaxCountSetRequest',
  full_name='ptypes.VolumeSnapshotMaxCountSetRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='count', full_name='ptypes.VolumeSnapshotMaxCountSetRequest.count', index=0,
...
_VOLUMEMAXIMUMTOTALSNAPSHOTSIZESETREQUEST = _descriptor.Descriptor(
  name='VolumeSnapshotMaxSizeSetRequest',
  full_name='ptypes.VolumeSnapshotMaxSizeSetRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='ptypes.VolumeSnapshotMaxSizeSetRequest.size', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['VolumeSnapshotMaxCountSetRequest'] = _VOLUMEMAXIMUMSNAPSHOTCOUNTSETREQUEST
DESCRIPTOR.message_types_by_name['VolumeSnapshotMaxSizeSetRequest'] = _VOLUMEMAXIMUMTOTALSNAPSHOTSIZESETREQUEST
...
VolumeSnapshotMaxCountSetRequest = _reflection.GeneratedProtocolMessageType('VolumeSnapshotMaxCountSetRequest', (_message.Message,), {
  'DESCRIPTOR' : _VOLUMEMAXIMUMSNAPSHOTCOUNTSETREQUEST,
  '__module__' : 'controller_pb2'
  # @@protoc_insertion_point(class_scope:ptypes.VolumeSnapshotMaxCountSetRequest)
  })
_sym_db.RegisterMessage(VolumeSnapshotMaxCountSetRequest)

VolumeSnapshotMaxSizeSetRequest = _reflection.GeneratedProtocolMessageType('VolumeSnapshotMaxSizeSetRequest', (_message.Message,), {
  'DESCRIPTOR' : _VOLUMEMAXIMUMTOTALSNAPSHOTSIZESETREQUEST,
  '__module__' : 'controller_pb2'
  # @@protoc_insertion_point(class_scope:ptypes.VolumeSnapshotMaxSizeSetRequest)
  })
_sym_db.RegisterMessage(VolumeSnapshotMaxSizeSetRequest)
...
_CONTROLLERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='VolumeSnapshotMaxCountSet',
    full_name='ptypes.ControllerService.VolumeSnapshotMaxCountSet',
    index=9,
    containing_service=None,
    input_type=_VOLUMEMAXIMUMSNAPSHOTCOUNTSETREQUEST,
    output_type=_VOLUME,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='VolumeSnapshotMaxSizeSet',
    full_name='ptypes.ControllerService.VolumeSnapshotMaxSizeSet',
    index=10,
    containing_service=None,
    input_type=_VOLUMEMAXIMUMTOTALSNAPSHOTSIZESETREQUEST,
    output_type=_VOLUME,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
