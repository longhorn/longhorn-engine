...
class ReplicaServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReplicaBench = channel.unary_unary(
                ...
                request_serializer=replica__pb2.ReplicaBenchRequest.SerializeToString,
                response_deserializer=replica__pb2.ReplicaBenchResponse.FromString,
                )
...
def add_ReplicaServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReplicaBench': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=replica__pb2.ReplicaBenchRequest.FromString,
                    response_serializer=replica__pb2.ReplicaBenchResponse.SerializeToString,
            ),
...
class ReplicaService(object):
    ...
    def ReplicaBench(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ptypes.ReplicaService/ReplicaBench',
            replica__pb2.ReplicaBenchRequest.SerializeToString,
            replica__pb2.ReplicaBenchResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
