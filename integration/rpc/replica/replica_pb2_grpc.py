...
class ReplicaServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SnapshotMaxCountSet = channel.unary_unary(
        ...
        request_serializer=replica__pb2.SnapshotMaxCountSetRequest.SerializeToString,
        response_deserializer=replica__pb2.SnapshotMaxCountSetResponse.FromString,
        )
    self.SnapshotMaxSizeSet = channel.unary_unary(
        '/ptypes.ReplicaService/SnapshotMaxSizeSet',
        request_serializer=replica__pb2.SnapshotMaxSizeSetRequest.SerializeToString,
        response_deserializer=replica__pb2.SnapshotMaxSizeSetResponse.FromString,
        )
...
def add_ReplicaServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'SnapshotMaxCountSet': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=replica__pb2.SnapshotMaxCountSetRequest.FromString,
          response_serializer=replica__pb2.SnapshotMaxCountSetResponse.SerializeToString,
      ),
      'SnapshotMaxSizeSet': grpc.unary_unary_rpc_method_handler(
          servicer.SnapshotMaxSizeSet,
          request_deserializer=replica__pb2.SnapshotMaxSizeSetRequest.FromString,
          response_serializer=replica__pb2.SnapshotMaxSizeSetResponse.SerializeToString,
      ),
  }
